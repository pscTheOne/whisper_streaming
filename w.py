...
parser.add_argument("--flask-port", type=int, default=5000,
                    help="The port on which the Flask server will run")
...
# shared data structure for storing transcriptions
transcriptions = []
...
class ServerProcessor:
    ...
    def format_output_transcript(self, o):
        ...
        if o[0] is not None:
            ...
            self.last_end = end
            transcript = "%1.0f %1.0f %s" % (beg, end, o[2])
            print(transcript, flush=True, file=sys.stderr)

            # Add transcript to the shared data structure
